...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Spline for Wine", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Spline for Wine";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Spline for Wine", null, { width: 640, height: 480 });
