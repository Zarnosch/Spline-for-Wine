...
::EnemyType_obj::__register();
::BulletType_obj::__register();
...
::Xml_obj::__register();
::EReg_obj::__register();
::__ASSET__assets_fonts_arial_ttf1_obj::__register();
::__ASSET__assets_fonts_nokiafc23_obj::__register();
...
::State_obj::__boot();
::EnemyType_obj::__boot();
::BulletType_obj::__boot();
...
::__ASSET__assets_fonts_nokiafc23_obj::__boot();
::__ASSET__assets_fonts_arial_ttf1_obj::__boot();
::Xml_obj::__boot();
