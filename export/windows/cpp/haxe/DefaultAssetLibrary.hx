...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		Font.registerFont (__ASSET__assets_fonts_nokiafc23);
		Font.registerFont (__ASSET__assets_fonts_arial_ttf1);
		...
		className.set ("assets/fonts/nokiafc22.ttf", __ASSET__assets_fonts_nokiafc23);
		type.set ("assets/fonts/nokiafc22.ttf", AssetType.FONT);
		
		className.set ("assets/fonts/arial.ttf", __ASSET__assets_fonts_arial_ttf1);
...
@:font("C:/HaxeToolkit/haxe/lib/flixel/3,3,11/assets/fonts/nokiafc22.ttf") @:keep #if display private #end class __ASSET__assets_fonts_nokiafc23 extends flash.text.Font {}
@:font("C:/HaxeToolkit/haxe/lib/flixel/3,3,11/assets/fonts/arial.ttf") @:keep #if display private #end class __ASSET__assets_fonts_arial_ttf1 extends flash.text.Font {}



@:keep class __ASSET__assets_fonts_arial_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/fonts/arial.ttf"; fontName = "Arial"; }}
@:keep class __ASSET__assets_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/fonts/nokiafc22.ttf"; fontName = "Nokia Cellphone FC Small"; }}
...
class __ASSET__assets_fonts_nokiafc23 extends openfl.text.Font { public function new () { super (); __fontPath = "assets/fonts/nokiafc22.ttf"; fontName = "Nokia Cellphone FC Small";  }}
class __ASSET__assets_fonts_arial_ttf1 extends openfl.text.Font { public function new () { super (); __fontPath = "assets/fonts/arial.ttf"; fontName = "Arial";  }}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		openfl.text.Font.registerFont (__ASSET__OPENFL__assets_fonts_nokiafc23);
		openfl.text.Font.registerFont (__ASSET__OPENFL__assets_fonts_arial_ttf1);
		...
		type.set (id, AssetType.SOUND);
		id = "assets/fonts/nokiafc22.ttf";
		className.set (id, __ASSET__assets_fonts_nokiafc23);
		
		type.set (id, AssetType.FONT);
		id = "assets/fonts/arial.ttf";
		className.set (id, __ASSET__assets_fonts_arial_ttf1);
...
@:keep @:bind #if display private #end class __ASSET__assets_fonts_nokiafc23 extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_arial_ttf1 extends null { }
...
@:keep #if display private #end class __ASSET__assets_fonts_nokiafc23 extends lime.text.Font { public function new () { super (); name = "Nokia Cellphone FC Small"; } } 
@:keep #if display private #end class __ASSET__assets_fonts_arial_ttf1 extends lime.text.Font { public function new () { super (); name = "Arial"; } } 


#else

@:keep #if display private #end class __ASSET__assets_fonts_arial_ttf extends lime.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/fonts/arial.ttf"; name = "Arial"; super (); }}
@:keep #if display private #end class __ASSET__assets_fonts_nokiafc22_ttf extends lime.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/fonts/nokiafc22.ttf"; name = "Nokia Cellphone FC Small"; super (); }}


#if (windows || mac || linux || cpp)


@:font("C:/HaxeToolkit/haxe/lib/flixel/3,3,11/assets/fonts/nokiafc22.ttf") #if display private #end class __ASSET__assets_fonts_nokiafc23 extends lime.text.Font {}
@:font("C:/HaxeToolkit/haxe/lib/flixel/3,3,11/assets/fonts/arial.ttf") #if display private #end class __ASSET__assets_fonts_arial_ttf1 extends lime.text.Font {}
...
#if (openfl && !flash)
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_arial_ttf extends openfl.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/fonts/arial.ttf"; name = "Arial"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/fonts/nokiafc22.ttf"; name = "Nokia Cellphone FC Small"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_nokiafc23 extends openfl.text.Font { public function new () { var font = new __ASSET__assets_fonts_nokiafc23 (); src = font.src; name = font.name; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_arial_ttf1 extends openfl.text.Font { public function new () { var font = new __ASSET__assets_fonts_arial_ttf1 (); src = font.src; name = font.name; super (); }}
